...
parser.add_argument('--dataset', type=str, default='AID_split1') 
...
parser.add_argument('--resume', type=str, default='/mnt/sdb/pzy/Awesome-Projects/VTEvo-FSL/checkpoint/AID_split1/best-1shot.pth') 
