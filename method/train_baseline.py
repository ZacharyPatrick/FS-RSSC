...
parser.add_argument('--name', type=str, default='acg-baseline-')
...
from model.visformer_baseline import visformer_tiny
import utils
...
def main(config):
    ...
    if args.resume:
        ...
        # init = '{}/checkpoint/visformer-{}.pth'.format(args.root, args.dataset)NWPU-RESISC45
        ...
        # init = '{}/checkpoint/miniImageNet-{}-shot.pth'.format(args.root, args.shot)
    ...
    # === Start of Modification: Freeze Backbone ===
