...
parser.add_argument('--dataset', type=str, default='NWPU-RESISC45') 
...
parser.add_argument('--epoch', type=int,default=800, choices=[1200,800,300]) 
parser.add_argument('--resume', type=str, default='/mnt/sdb/pzy/Awesome-Projects/VTEvo-FSL/checkpoint/NWPU-RESISC45/best-1shot.pth') 
...
def main(args):
    ...
    lr_scheduler = CosineLRScheduler(optimizer, 
                                    t_initial=args.epoch-80, 
                                    lr_min=1.e-6,
                                    warmup_t=80,
                                    warmup_lr_init=5.e-6, 
                                    warmup_prefix=True)
